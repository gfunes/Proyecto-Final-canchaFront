import CardCancha, { type CanchaData } from '../services/CardCancha';

interface SelectorCanchaProps {
  onSeleccionarCancha: (cancha: CanchaData) => void;
}
...
export default function SelectorCancha({ onSeleccionarCancha }: SelectorCanchaProps) {
  return (
