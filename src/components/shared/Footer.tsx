...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 border-t-4 border-green-600 text-slate-400 py-10 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-green-500 via-transparent to-transparent"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center justify-center gap-3">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xl font-black italic uppercase tracking-tighter bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
              TuCancha App
            </span>
          </div>
